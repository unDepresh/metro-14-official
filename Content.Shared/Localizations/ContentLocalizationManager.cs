...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        private const string Culture = "ru-RU";// Metro14-Localization
        private const string FallbackCulture = "en-US"; // Metro14-Localization
        ...
        public void Initialize()
        {
            ...
            var fallbackCulture = new CultureInfo(FallbackCulture); // Metro14-Localization

            _loc.LoadCulture(culture);
            _loc.LoadCulture(fallbackCulture); // Metro14-Localization
            _loc.SetFallbackCluture(fallbackCulture); // Metro14-Localization
            _loc.AddFunction(culture, "MANY", FormatMany); // Metro14-Localization: To prevent problems in auto-generated locale files
