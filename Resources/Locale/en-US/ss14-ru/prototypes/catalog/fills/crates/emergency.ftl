...
ent-CrateEmergencyInternals = internals crate
    .desc = Master your life energy and control your breathing with three breath masks, three gas masks, three emergency EVA suits, three oxygen tanks, and three nitrogen tanks.
ent-CrateEmergencyInternalsLarge = internals crate (large)
    .desc = Master your life energy and control your breathing with six breath masks, six gas masks, six emergency EVA suits, six oxygen tanks, and six nitrogen tanks.
ent-CrateNitrogenInternals = internals crate (nitrogen)
    .desc = Contains two breath masks, two gas masks, and four nitrogen tanks. Intended for nitrogen-breathing species.
